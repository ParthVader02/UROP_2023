...
#             output_image = cv2.resize(img, new_size) #input and output are the same image
...
img = cv2.imread("raw_data/im2.jpg")

blur_length = random.randint(10, 30) #change blur amount 
angle = random.randint(0, 180) #change angle of blur
thickness = random.randint(0, 1) #change thickness of blur
